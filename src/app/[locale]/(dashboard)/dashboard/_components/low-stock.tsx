...
export default function LowStockPage() {
  ...
  const allProducts =
    ...
    const sortedProducts = [...allProducts].sort((second,first) => second.quantity - first.quantity)
  ...
  return (
    <>
      ...
      <Card className=" w-full border-none">
        <CardHeader>
          <CardTitle>
            <h1 className="font-semibold text-2xl w-full">Low Stock Products</h1>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div
          ...
          >
            ...
            >
              ...
              {isLoading ? (
                ...
                <>
                  {sortedProducts.map((product: LowStockProduct, index: number) => (
                  <div key={product._id}>
