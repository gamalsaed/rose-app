...
export default async function getAllNotifications(currentPage : number) {
  ...
  const res = await fetch(`https://flower.elevateegy.com/api/v1/notifications/user?limit=${5}&page=${currentPage}`, {
    method: 'GET',
    headers: {
